...
research_on_optimizer_path = "/home/jingqi/DeepLearningWorkshop/recipes/research_on_optimizer"
optimizer_type = [
    "sgd",
    "sgd_with_momentum",
    "Nestrov",
...
res_path = "/home/jingqi/DeepLearningWorkshop/results/research_on_optimizer"
# sgd配置文件
def sgd_config():
    param_ranges = [lr]
